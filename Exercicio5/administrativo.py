...
class Administrativo(Funcionario):
    ...
    def emprestar(self, titulo_livro: str):
        if isinstance(titulo_livro, str):
            return\
"""Funcionario administrativo do departamento "{departamento}" pegou emprestado o livro: {livro} com {dias_de_emprestimo} dias de prazo"""\
            .format(
    ...
    def devolver(self, titulo_livro: str):
        if isinstance(titulo_livro, str):
            return\
"""Funcionario administrativo do departamento "{departamento}" devolveu o livro: {livro}"""\
            .format(
                departamento = self.__departamento,
                livro = titulo_livro)
